    ...
    <div className="category-container d-flex justify-content-center align-items-center mx-2 my-2">
      ...
      <div className="bg-green-100 py-4 mt-2">
        <div className="grid gap-4 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
          <div className="w-36 justify-center mx-auto">
            <Link to="/AgroShop/Category" className="block">
              <img
                className="rounded-full"
                src="https://raw.githubusercontent.com/IkkiOcean/AgroTech_Assets/main/shop-asset/category-img/all.jpg"
                alt="All Categories"
              />
          ...
          {categories.map((category, index) => (
            <div key={index} className="w-36 justify-center mx-auto">
              <Link to={`/AgroShop/Category/${category.alias}`}>
                <img
                  className="rounded-full"
                  src={category.image}
                  alt={category.title}
