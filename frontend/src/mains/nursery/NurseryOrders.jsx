    ...
    <div className="w-full min-h-screen bg-[#f7faf8] pt-16 sm:pt-20 font-sans">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="max-w-3xl">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-emerald-300/25 bg-white/10 px-3 py-1.5 text-xs font-bold uppercase tracking-[0.14em] text-emerald-100">
              <Sparkles size={14} className="text-lime-300" /> Order tracking
            </div>
            <h1 className="max-w-2xl text-3xl font-extrabold tracking-tight text-white sm:text-5xl">My Orders</h1>
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-emerald-50/80">View your order history and track deliveries.</p>
          </div>
        </div>
      </section>
      <main className="relative z-10 mx-auto max-w-7xl px-4 pb-16 sm:px-6 sm:pb-20">
        <div className="-mt-7 bg-white border border-slate-200 rounded-3xl shadow-2xl p-6 sm:p-10 text-center">
          ...
          <h2 className="text-xl font-bold text-slate-700">Orders coming soon</h2>
          <p className="text-sm text-slate-400 mt-2">Order tracking is under development.</p>
        </div>
      </main>
    </div>
  );
