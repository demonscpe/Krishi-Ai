...
const ContributorsPage = () => {
    ...
    return (
        <>
            <section className="pt-20 pb-16 min-h-screen bg-gradient-to-b from-green-50 to-white font-poppins">
                <div className="contributor-contributors">
                    {loading ? (
                        ...
                        <h2 className="text-2xl font-bold text-green-700 mb-6 text-center">
                            ...
                            {renderStats()}
                            <h2 className="text-2xl font-bold text-green-800 mt-12 mb-6 text-center">
