...
import {
  Sprout, Search, ArrowRight, Sparkles, CheckCircle2,
  RefreshCw, BarChart3, Leaf, Beaker
} from 'lucide-react';
...
const cropModules = [
  {
    ...
    description: 'Get AI-powered crop suggestions based on soil parameters, climate conditions, and seasonal data.',
    icon: Sprout,
    ...
    path: '/crop',
    features: ['Soil-based prediction', 'Climate analysis', 'Multi-crop suggestions'],
  },
  {
    id: 'identification',
    title: 'Crop Identification',
    description: 'Identify crop varieties, growth stages, and health indicators from uploaded images using AI vision.',
    icon: Search,
    color: 'bg-blue-500',
    ...
    features: ['Image recognition', 'Variety detection', 'Growth stage analysis'],
  },
  {
    id: 'rotation',
    title: 'Crop Rotation Recommendation',
    description: 'Plan optimal crop rotations to maintain soil fertility, prevent diseases, and maximize yield.',
    icon: RefreshCw,
    color: 'bg-purple-500',
    ...
    features: ['Rotation planning', 'Soil fertility focus', 'Disease prevention'],
  },
  {
    id: 'rotation-plan',
    title: 'AI Crop Rotation Plan',
    description: 'Generate a comprehensive seasonal rotation plan with detailed timelines and crop sequences.',
    icon: BarChart3,
    color: 'bg-amber-500',
    gradient: 'from-amber-600 to-amber-700',
    lightBg: 'bg-amber-50',
    lightText: 'text-amber-600',
    path: '/crop_Rotation_AI',
    features: ['Seasonal timelines', 'Crop sequencing', 'Yield optimization'],
  },
  {
    id: 'dashboard',
    title: 'Crop Analytics Dashboard',
    description: 'Track and analyze your crop prediction history, recommendations, and performance insights.',
    icon: Leaf,
    color: 'bg-green-500',
    ...
    path: '/crop/dashboard',
    features: ['Prediction history', 'Statistics & charts', 'Performance tracking'],
  },
];
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-emerald-300/25 bg-white/10 px-3 py-1.5 text-xs font-bold uppercase tracking-[0.14em] text-emerald-100">
              <Sparkles size={14} className="text-lime-300" /> AI crop intelligence suite
            </div>
            <h1 className="max-w-2xl text-3xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
              Complete Crop Intelligence Platform
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-emerald-50/80 sm:text-lg">
              From recommendations to rotation planning — manage every aspect of your crop farming with AI-powered insights.
            </p>
          </div>
          <div className="mt-8 flex flex-wrap gap-x-6 gap-y-3 text-sm font-medium text-emerald-100">
            <span className="flex items-center gap-2"><CheckCircle2 size={16} className="text-lime-300" /> AI-powered predictions</span>
            <span className="flex items-center gap-2"><CheckCircle2 size={16} className="text-lime-300" /> Smart crop planning</span>
            <span className="flex items-center gap-2"><CheckCircle2 size={16} className="text-lime-300" /> Data-driven insights</span>
          </div>
        </div>
      </section>
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-4 pb-16 sm:px-6 sm:pb-20">
        ...
        <div className="mt-10 bg-gradient-to-br from-green-700 to-emerald-600 rounded-3xl p-8 sm:p-12 text-white text-center">
          ...
          <p className="max-w-2xl mx-auto text-sm leading-relaxed text-emerald-50/80">
            Start with crop recommendations based on your soil data, identify crop varieties through images,
            plan optimal rotations, and track all your predictions in the analytics dashboard — all within the same integrated platform.
          </p>
        </div>
      </main>
    </div>
