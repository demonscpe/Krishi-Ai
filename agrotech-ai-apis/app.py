...
# Input: { category, Nitrogen, Phosphorus, Potassium, Temperature, Humidity, ph, Rainfall }
# Output: { Prediction, Confidence, Alternatives, AIInsight, Category }
