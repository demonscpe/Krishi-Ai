...
def chat():
    ...
    messages = [
        {'role': "system", "content": "You are an AI assistant for Krishi-Ai, an innovative platform that leverages artificial intelligence to enhance agricultural practices. Provide helpful and accurate information about Krishi-Ai's services and agricultural technology."},
